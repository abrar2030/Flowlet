...
To run the tests, ensure you have Node.js and npm/yarn installed. Navigate to the `web-frontend` directory and install the necessary dependencies:
...
Then, you can execute the tests from the `web-frontend` directory:
