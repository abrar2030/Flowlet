"""
Flowlet API Application - Backend Only
"""
...
app.config.update({
    ...
    "SQLALCHEMY_DATABASE_URI": os.environ.get("DATABASE_URL", "sqlite:///flowlet_api.db"),
...
# Configure CORS - Allow all origins for frontend-backend interaction
