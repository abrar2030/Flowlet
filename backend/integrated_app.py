"""
Integrated Flowlet Application
Serves both the React frontend and Flask backend API
"""
...
@app.route('/api/v1/transactions/send', methods=['POST'])
@token_required
def send_money():
...
@app.route('/api/v1/transactions/deposit', methods=['POST'])
@token_required
def deposit_money():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to deposit money'}), 500
