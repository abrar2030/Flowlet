...
class RegulatoryFramework:
    ...
    def _initialize_jurisdiction_profiles(self):
        ...
        self._jurisdiction_profiles[Jurisdiction.EU] = JurisdictionProfile(
            ...
            name="European Union",
            regulatory_bodies=["EBA", "ESMA", "EIOPA", "ECB", "National Competent Authorities"],
        ...
        self._jurisdiction_profiles[Jurisdiction.US] = JurisdictionProfile(
            ...
            name="United States",
            regulatory_bodies=["FinCEN", "CFPB", "OCC", "FDIC", "Federal Reserve", "SEC", "CFTC"],
    ...
    def _add_us_rules(self):
        ...
        self._rules["us_bsa_sar"] = ComplianceRule(
            ...
            requirements={
                ...
                "suspicious_indicators": ["structuring", "unusual_patterns", "high_risk_countries"]
            },
            penalties={
                "civil_penalty": "$25,000 per violation",
                "criminal_penalty": "$500,000 and/or 5 years imprisonment"
    ...
    def get_applicable_rules(self, jurisdiction: Jurisdiction, entity_type: str,
                           current_date: datetime = None) -> List[ComplianceRule]:
        ...
        for rule in self._rules.values():
            ...
            if rule.jurisdiction == jurisdiction or rule.jurisdiction == Jurisdiction.GLOBAL:
    ...
    def get_jurisdiction_profile(self, jurisdiction: Jurisdiction) -> Optional[JurisdictionProfile]:
    ...
    def get_rules_by_category(self, category: RuleCategory, 
                            jurisdiction: Jurisdiction = None) -> List[ComplianceRule]:
        ...
        for rule in self._rules.values():
            if rule.category == category:
                if jurisdiction is None or rule.jurisdiction == jurisdiction or rule.jurisdiction == Jurisdiction.GLOBAL:
                    filtered_rules.append(rule)
        
        return filtered_rules
    
    def get_rules_by_severity(self, severity: RuleSeverity,
                            jurisdiction: Jurisdiction = None) -> List[ComplianceRule]:
    ...
    def get_compliance_requirements(self, jurisdiction: Jurisdiction,
    ...
    def validate_transaction_limits(self, jurisdiction: Jurisdiction,
                                  amount: float, currency: str,
                                  transaction_type: str = "payment") -> Dict[str, Any]:
        ...
        if 'cash_transaction_limit' in limits and transaction_type == 'cash' and amount > limits['cash_transaction_limit']:
            violations.append(f"Exceeds cash transaction limit of {limits['cash_transaction_limit']}")
    ...
    def get_reporting_requirements(self, jurisdiction: Jurisdiction,
        ...
        if transaction_amount:
            if 'large_transaction_reporting' in reporting_reqs:
                ...
                reporting_reqs['large_transaction_required'] = transaction_amount >= threshold
