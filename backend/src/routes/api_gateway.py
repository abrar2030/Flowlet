...
def gateway_status():
    ...
    try:
        ...
        overall_status = 'operational' if all(s == 'healthy' for s in health_status.values()) else 'degraded'
        ...
        return jsonify({'error': 'Internal server error during status check', 'code': 'INTERNAL_ERROR'}), 500
