...
class CurrencyExchangeService:
    ...
    def __init__(self):
        ...
        self.cache_ttl = int(os.environ.get('EXCHANGE_RATE_CACHE_TTL', '300'))  # 5 minutes
    ...
    def get_exchange_rate(self, from_currency: str, to_currency: str, 
                         provider: str = 'exchangerate_api') -> Optional[ExchangeRate]:
        """
        ...
        try:
            ...
            if provider != 'fixer':
                logger.warning(f"Primary provider failed, trying backup for {from_currency}/{to_currency}")
                backup_rate = self._fetch_rate_from_provider(from_currency, to_currency, 'fixer')
                if backup_rate:
    ...
    def _fetch_rate_from_provider(self, from_currency: str, to_currency: str, 
                                 provider: str) -> Optional[ExchangeRate]:
    ...
    def _fetch_from_exchangerate_api(self, from_currency: str, to_currency: str) -> Optional[ExchangeRate]:
    ...
    def _fetch_from_fixer(self, from_currency: str, to_currency: str) -> Optional[ExchangeRate]:
    ...
    def _fetch_from_currencylayer(self, from_currency: str, to_currency: str) -> Optional[ExchangeRate]:
    ...
    def convert_currency(self, amount: Decimal, from_currency: str, to_currency: str,
                        rate: Optional[Decimal] = None) -> Optional[Decimal]:
        """
    ...
    def get_historical_rates(self, from_currency: str, to_currency: str,
                           start_date: datetime, end_date: datetime) -> List[ExchangeRate]:
        """
    ...
    def calculate_cross_rate(self, currency_a: str, currency_b: str, 
                           base_currency: str = 'USD') -> Optional[Decimal]:
        """
