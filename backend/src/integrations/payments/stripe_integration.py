...
class PaymentProcessor(ABC):
    ...
    @abstractmethod
    def process_payment(self, amount: Decimal, currency: str, payment_details: Dict) -> Dict:
        """Process a payment"""
        pass
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    'success': False,
                    'error': 'STRIPE_ERROR',
                    'message': error_data.get('error', {}).get('message', 'Unknown Stripe error'),
                    'processor': 'stripe'
                }
...
class WirePaymentProcessor(PaymentProcessor):
    ...
    def __init__(self):
        ...
        self.base_url = os.environ.get('WIRE_BASE_URL', 'https://api.wireprovider.com/v1')
    ...
    def process_payment(self, amount: Decimal, currency: str, payment_details: Dict) -> Dict:
        ...
        try:
            ...
            required_fields = ['beneficiary_name', 'beneficiary_account', 'beneficiary_bank']
...
class SEPAPaymentProcessor(PaymentProcessor):
    ...
    def __init__(self):
        ...
        self.base_url = os.environ.get('SEPA_BASE_URL', 'https://api.sepaprovider.com/v1')
