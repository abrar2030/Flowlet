...
class ConfigurationEngine:
    ...
    def _register_default_validators(self):
        ...
        def validate_min_value(value: Union[int, float], rule_value: Union[int, float]) -> bool:
            return float(value) >= float(rule_value)
        
        def validate_max_value(value: Union[int, float], rule_value: Union[int, float]) -> bool:
            return float(value) <= float(rule_value)
    ...
    def create_template(self, name: str, description: str, category: str,
                       sections: List[ConfigSection]) -> str:
        """
    ...
    def create_instance(self, template_id: str, name: str, description: str,
                       values: Dict[str, Any] = None, created_by: str = None) -> str:
        """
    ...
    def update_instance(self, instance_id: str, values: Dict[str, Any],
        ...
        # Notify listeners
        self._notify_change_listeners(instance_id, "updated", instance.values, old_values)
        ...
        for field_id, field in all_fields.items():
            ...
            for rule_name, rule_value in field.validation_rules.items():
                ...
                if validator and not validator(value, rule_value):
                    errors.append(f"Field '{field.name}' failed validation rule: {rule_name}")
        
        return errors
    
    def _collect_fields(self, section: ConfigSection, fields_dict: Dict[str, ConfigField]):
    ...
    def _notify_change_listeners(self, instance_id: str, action: str, 
                               new_values: Dict[str, Any], old_values: Dict[str, Any] = None):
    ...
    def list_instances(self, template_id: str = None, status: str = None) -> List[ConfigInstance]:
        """
