...
class NotificationService:
    ...
    def _send_sms(
        self, phone: str, message: str, metadata: Optional[Dict] = None
    ) -> Dict:
    ...
    def _send_in_app(
        ...
        try:
            ...
            # For now, just log the attempt
            logger.info(
                f"In-app notification would be stored for user {user_id}: {message}"
            )
    ...
    def _send_webhook(
        ...
        try:
            ...
            # For now, just log the attempt
            logger.info(
                f"Webhook notification would be sent for user {user_id}: {message}"
            )
    ...
    def _get_email_template(
        self, notification_type: str, message: str, metadata: Optional[Dict] = None
    ) -> str:
