...
class BusinessMetrics(Base):
    ...
    metric_category = Column(String(50), nullable=False)  # revenue, risk, compliance, operational
...
class RegulatoryReport(Base):
    ...
    # Submission Details
    submission_status = Column(String(20), default='draft')  # draft, submitted, acknowledged
    ...
    __table_args__ = (
        Index('idx_regulatory_reports_type_jurisdiction', 'report_type', 'jurisdiction'),
...
class PerformanceMetrics(Base):
    ...
    __table_args__ = (
        Index('idx_performance_metrics_service_time', 'service_name', 'measurement_timestamp'),
