    ...
    try:
        with app.app_context():
            ...
            from src.models.database import (
                User, Wallet, Transaction, Card, KYCRecord, 
                LedgerEntry, FraudAlert, APIKey, AuditLog
            )
...
def main():
    ...
    print("- 8 microservices implemented (Wallet, Payment, Card, KYC/AML, Ledger, AI, Security, API Gateway)")
