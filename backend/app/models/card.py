...
from sqlalchemy import Column, String, Boolean, DateTime, BigInteger, ForeignKey, Enum, Text, Integer
...
class Card(db.Model):
    ...
    card_number_token = Column(String(100), nullable=False, unique=True)  # Tokenized card number
    ...
    def to_dict(self, include_sensitive: bool = False) -> dict:
        ...
        if include_sensitive:
            data.update({
                ...
                "pin_locked_until": self.pin_locked_until.isoformat() if self.pin_locked_until else None
            })
