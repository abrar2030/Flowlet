...
from sqlalchemy import Column, String, DateTime, Text, Enum, Integer, ForeignKey, Boolean
...
class AuditLog(db.Model):
    ...
    # Target information
    target_type = Column(String(50), nullable=False)  # e.g., 'User', 'Account', 'Transaction'
