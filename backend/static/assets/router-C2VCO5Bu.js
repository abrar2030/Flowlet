import { r as Oe, g as he, a as Ie } from "./vendor-DJG_os-6.js";
function Ne(e, t) {
...
var u = Oe();
const Te = he(u),
  lr = Ne({ __proto__: null, default: Te }, [u]);
var B = {},
  le;
function De() {
  if (le) return B;
  ...
  function s(d, v) {
    const f = new o(),
      y = d.length;
    if (y < 2) return f;
    const w = (v == null ? void 0 : v.decode) || m;
    let h = 0;
    do {
      const g = d.indexOf("=", h);
      if (g === -1) break;
  ...
  function i(d, v, f) {
    ...
    const w = y(v);
    if (!t.test(w)) throw new TypeError(`argument val is invalid: ${v}`);
    let h = d + "=" + w;
    if (!f) return h;
    if (f.maxAge !== void 0) {
...
function _({ pathname: e = "/", search: t = "", hash: r = "" }) {
  return (
...
function Me(e, t, r, a = {}) {
  ...
  function p() {
    ...
    let w = m(),
      h = w == null ? null : w - i;
    ((i = w), l && l({ action: c, location: y.location, delta: h }));
  }
  function d(w, h) {
    c = "PUSH";
    let g = X(y.location, w, h);
    i = m() + 1;
    let x = se(g, i),
      R = y.createHref(g);
    try {
  ...
  let y = {
    ...
    listen(w) {
      ...
      return (
        n.addEventListener(ue, p),
        (l = w),
        () => {
          (n.removeEventListener(ue, p), (l = null));
        }
      );
    },
    createHref(w) {
...
function Be(e, t = !1) {
  ...
  (typeof window < "u" &&
    ...
    E(r, "No window.location.(origin|href) available to create URL"));
  let a = typeof e == "string" ? e : _(e);
  return (
    (a = a.replace(/ $/, "%20")),
...
function pe(e, t = [], r = [], a = "") {
  let n = (o, s, c) => {
    ...
    (o.children &&
      ...
      pe(o.children, t, m, i)),
      !(o.path == null && !o.index) &&
        t.push({ path: i, score: Ke(i, o.index), routesMeta: m }));
  };
  return (
    e.forEach((o, s) => {
      var c;
      if (o.path === "" || !((c = o.path) != null && c.includes("?"))) n(o, s);
      else for (let l of ye(o.path)) n(o, s, l);
    }),
    t
  );
}
...
function Ke(e, t) {
  ...
  return (
    ...
    r
      .filter((n) => !ce(n))
      .reduce((n, o) => n + (He.test(o) ? We : o === "" ? ze : Ve), a)
  );
}
function Ye(e, t) {
...
function qe(e, t, r = !1) {
  ...
  for (let c = 0; c < a.length; ++c) {
    ...
    (Object.assign(n, p.params),
      s.push({
        params: n,
        pathname: L([o, p.pathname]),
        pathnameBase: tt(L([o, p.pathnameBase])),
        route: d,
      }),
      p.pathnameBase !== "/" && (o = L([o, p.pathnameBase])));
  }
  return s;
}
function J(e, t) {
  typeof e == "string" && (e = { path: e, caseSensitive: !1, end: !0 });
  let [r, a] = Ge(e.path, e.caseSensitive, e.end),
    n = t.match(r);
  if (!n) return null;
  let o = n[0],
    s = o.replace(/(.)\/+$/, "$1"),
    c = n.slice(1);
  return {
    params: a.reduce((i, { paramName: m, isOptional: p }, d) => {
      if (m === "*") {
        let f = c[d] || "";
      ...
      const v = c[d];
      return (
        p && !v ? (i[m] = void 0) : (i[m] = (v || "").replace(/%2F/g, "/")),
        i
      );
    }, {}),
    pathname: o,
    ...
    n =
      ...
      e
        ...
        .replace(
          /\/:([\w-]+)(\?)?/g,
          (s, c, l) => (
            a.push({ paramName: c, isOptional: l != null }),
            l ? "/?([^\\/]+)?" : "/([^\\/]+)"
          ),
        );
  return (
...
function ee(e, t, r, a = !1) {
  ...
  typeof e == "string"
    ...
    : ((n = { ...e }),
      ...
      E(!n.search || !n.search.includes("#"), q("#", "search", "hash", n)));
  let o = e === "" || n.pathname === "",
    s = o ? "/" : n.pathname,
    c;
  if (s == null) c = r;
...
var K = u.createContext(null);
K.displayName = "DataRouterState";
var ve = u.createContext({ isTransitioning: !1 });
ve.displayName = "ViewTransition";
var it = u.createContext(new Map());
...
var k = u.createContext({ outlet: null, matches: [], isDataRoute: !1 });
k.displayName = "Route";
var te = u.createContext(null);
te.displayName = "RouteError";
function ut(e, { relative: t } = {}) {
  E(M(), "useHref() may be used only in the context of a <Router> component.");
  let { basename: r, navigator: a } = u.useContext(P),
    { hash: n, pathname: o, search: s } = W(e, { relative: t }),
    c = o;
  return (
    r !== "/" && (c = o === "/" ? r : L([r, o])),
    a.createHref({ pathname: c, search: s, hash: n })
  );
}
function M() {
  return u.useContext(H) != null;
}
function N() {
  return (
    E(
...
function st() {
  ...
  let e = u.useContext(A),
    { basename: t, navigator: r } = u.useContext(P),
    { matches: a } = u.useContext(k),
    { pathname: n } = N(),
    o = JSON.stringify(Z(a)),
    s = u.useRef(!1);
  return (
    xe(() => {
      s.current = !0;
    ...
    u.useCallback(
      (l, i = {}) => {
        if ((S(s.current, we), !s.current)) return;
        if (typeof l == "number") {
          r.go(l);
          return;
        }
        let m = ee(l, JSON.parse(o), n, i.relative === "path");
        (e == null &&
          t !== "/" &&
          (m.pathname = m.pathname === "/" ? t : L([t, m.pathname])),
          (i.replace ? r.replace : r.push)(m, i.state, i));
      },
      [t, r, o, n, e],
    )
  );
}
var ct = u.createContext(null);
function ft(e) {
  let t = u.useContext(k).outlet;
  return t && u.createElement(ct.Provider, { value: e }, t);
}
function W(e, { relative: t } = {}) {
  let { matches: r } = u.useContext(k),
    { pathname: a } = N(),
    n = JSON.stringify(Z(r));
  return u.useMemo(() => ee(e, JSON.parse(n), a, t === "path"), [e, n, a, t]);
}
function dt(e, t) {
  return Re(e, t);
}
function Re(e, t, r, a) {
  ...
  let { navigator: n } = u.useContext(P),
    { matches: o } = u.useContext(k),
    s = o[o.length - 1],
    c = s ? s.params : {},
    l = s ? s.pathname : "/",
    i = s ? s.pathnameBase : "/",
...
Please change the parent <Route path="${g}"> to <Route path="${g === "/" ? "*" : `${g}/*`}">.`,
  ...
  let p = N(),
    d;
  if (t) {
    let g = typeof t == "string" ? F(t) : t;
    (E(
      i === "/" || ((h = g.pathname) == null ? void 0 : h.startsWith(i)),
      `When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${i}" but pathname "${g.pathname}" was given in the \`location\` prop.`,
    ),
      (d = g));
  } else d = p;
  let v = d.pathname || "/",
    f = v;
  if (i !== "/") {
    let g = i.replace(/^\//, "").split("/");
    f = "/" + v.replace(/^\//, "").split("/").slice(g.length).join("/");
  }
  let y = me(e, { pathname: f });
  (S(
    m || y != null,
  ...
  let w = gt(
    y &&
      y.map((g) =>
        Object.assign({}, g, {
          params: Object.assign({}, c, g.params),
          pathname: L([
            i,
            n.encodeLocation
  ...
  return (
    ...
    (s = u.createElement(
      ...
      u.createElement(
        ...
        u.createElement("code", { style: o }, "ErrorBoundary"),
        " or",
        " ",
        u.createElement("code", { style: o }, "errorElement"),
        " prop on your route.",
      ),
    )),
    u.createElement(
      ...
      r ? u.createElement("pre", { style: n }, r) : null,
      s,
    )
  );
}
var mt = u.createElement(ht, null),
  pt = class extends u.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
...
function yt({ routeContext: e, match: t, children: r }) {
  ...
  return (
    ...
    u.createElement(k.Provider, { value: e }, r)
  );
}
function gt(e, t = [], r = null, a = null) {
  if (e == null) {
    if (!r) return null;
  ...
  if (r)
    for (let l = 0; l < n.length; l++) {
      let i = n[l];
      if (
        ((i.route.HydrateFallback || i.route.hydrateFallbackElement) && (c = l),
        i.route.id)
      ) {
        let { loaderData: m, errors: p } = r,
          d =
            i.route.loader &&
            !m.hasOwnProperty(i.route.id) &&
            (!p || p[i.route.id] === void 0);
        if (i.route.lazy || d) {
  ...
  return n.reduceRight((l, i, m) => {
    let p,
      ...
      f = null;
    r &&
      ((p = o && i.route.id ? o[i.route.id] : void 0),
      (v = i.route.errorElement || mt),
      s &&
        (c < 0 && m === 0
          ? (Ce(
              "route-fallback",
            ...
            (f = null))
          : c === m &&
            ((d = !0), (f = i.route.hydrateFallbackElement || null))));
    let y = t.concat(n.slice(0, m + 1)),
      w = () => {
        let h;
        return (
          p
            ...
            : d
              ? (h = f)
              : i.route.Component
                ? (h = u.createElement(i.route.Component, null))
                : i.route.element
                  ? (h = i.route.element)
                  : (h = l),
          u.createElement(yt, {
    ...
    return r && (i.route.ErrorBoundary || i.route.errorElement || m === 0)
      ? u.createElement(pt, {
          location: r.location,
...
function ne(e) {
  ...
  return (
    E(r.route.id, `${e} can only be used on routes that contain a unique "id"`),
    r.route.id
  );
}
function Et() {
  return ne("useRouteId");
}
function Rt() {
  var a;
...
u.memo(bt);
function bt({ routes: e, future: t, state: r }) {
  return Re(e, void 0, r, t);
}
function ur({ to: e, replace: t, state: r, relative: a }) {
  E(M(), "<Navigate> may be used only in the context of a <Router> component.");
  let { static: n } = u.useContext(P);
  S(
    !n,
    "<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.",
  );
  let { matches: o } = u.useContext(k),
    { pathname: s } = N(),
    c = Ee(),
    l = ee(e, Z(o), s, a === "path"),
    i = JSON.stringify(l);
  return (
    u.useEffect(() => {
      c(JSON.parse(i), { replace: t, state: r, relative: a });
    }, [c, i, a, t, r]),
    null
  );
}
  ...
  let {
    ...
    v = u.useMemo(() => {
      ...
      return f == null
        ? null
        : {
            location: { pathname: f, search: i, hash: m, state: p, key: d },
            navigationType: a,
          };
    }, [s, l, i, m, p, d, a]);
  return (
    S(
      v != null,
      `<Router basename="${s}"> is not able to match the URL "${l}${i}${m}" because it does not start with the basename, so the <Router> won't render anything.`,
    ),
    v == null
      ? null
      : u.createElement(
          P.Provider,
          { value: c },
          u.createElement(H.Provider, { children: t, value: v }),
        )
  );
}
function cr({ children: e, location: t }) {
  return dt(Q(e), t);
}
function Q(e, t = []) {
  let r = [];
  return (
    u.Children.forEach(e, (a, n) => {
      if (!u.isValidElement(a)) return;
      let o = [...t, n];
      if (a.type === u.Fragment) {
        r.push.apply(r, Q(a.props.children, o));
        return;
      }
      (E(
        a.type === St,
      ...
      (a.props.children && (s.children = Q(a.props.children, o)), r.push(s));
    }),
    r
  );
}
...
function Dt(e, t) {
  ...
  if (Lt(e)) {
    ...
    ((a = c ? $(c, t) : null),
      ...
      (n = G(e.getAttribute("enctype")) || V),
      (o = new FormData(e)));
  } else if (kt(e) || ($t(e) && (e.type === "submit" || e.type === "image"))) {
    let c = e.form;
    if (c == null)
      throw new Error(
    ...
    if (
      ((a = l ? $(l, t) : null),
      (r = e.getAttribute("formmethod") || c.getAttribute("method") || z),
      (n =
        G(e.getAttribute("formenctype")) || G(c.getAttribute("enctype")) || V),
      (o = new FormData(c, e)),
      !Nt())
    ) {
  ...
  let s = (l, i) => (r[i] ? l.route.id !== r[i].route.id : !0),
    c = (l, i) => {
      ...
      return (
        ...
        (((m = r[i].route.path) == null ? void 0 : m.endsWith("*")) &&
          r[i].params["*"] !== l.params["*"])
      );
    };
  return o === "assets"
    ? t.filter((l, i) => s(l, i) || c(l, i))
    : o === "data"
      ? t.filter((l, i) => {
          var p;
          let m = a.routes[l.route.id];
          if (!m || !m.hasLoader) return !1;
          if (s(l, i) || c(l, i)) return !0;
...
function Bt(e, t, { includeHydrateFallback: r } = {}) {
  return Ut(
    e
      .map((a) => {
...
function Ht(e, t) {
  ...
  return (
    new Set(t),
    e.reduce((a, n) => {
      let o = JSON.stringify(_t(n));
      return (r.has(o) || (r.add(o), a.push({ key: o, link: n })), a);
    }, [])
  );
}
Object.getOwnPropertyNames(Object.prototype).sort().join("\0");
var Wt = new Set([100, 101, 204, 205]);
function jt(e, t) {
  let r =
    typeof e == "string"
      ? new URL(
...
var oe = u.createContext(void 0);
oe.displayName = "FrameworkContext";
function Se() {
  let e = u.useContext(oe);
  return (
    ae(e, "You must render this element inside a <HydratedRouter> element"),
    e
  );
}
function Vt(e, t) {
  let r = u.useContext(oe),
    [a, n] = u.useState(!1),
    [o, s] = u.useState(!1),
    {
      onFocus: c,
...
function Jt({ page: e, ...t }) {
  let { router: r } = be(),
    a = u.useMemo(() => me(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return a ? u.createElement(Yt, { page: e, matches: a, ...t }) : null;
}
function Kt(e) {
...
function Yt({ page: e, matches: t, ...r }) {
  let a = N(),
    { manifest: n, routeModules: o } = Se(),
    { basename: s } = be(),
    { loaderData: c, matches: l } = zt(),
    i = u.useMemo(() => de(e, t, l, n, a, "data"), [e, t, l, n, a]),
    m = u.useMemo(() => de(e, t, l, n, a, "assets"), [e, t, l, n, a]),
    p = u.useMemo(() => {
      ...
      if (
        (t.forEach((h) => {
          var x;
          let g = n.routes[h.route.id];
          !g ||
            !g.hasLoader ||
            ((!i.some((R) => R.route.id === h.route.id) &&
              h.route.id in c &&
              (x = o[h.route.id]) != null &&
              x.shouldRevalidate) ||
            g.hasClientLoader
  ...
  return u.createElement(
    ...
    d.map((f) =>
      u.createElement("link", { key: f, rel: "modulepreload", href: f, ...r }),
    ),
    v.map(({ key: f, link: y }) => u.createElement("link", { key: f, ...y })),
  );
}
function qt(...e) {
  return (t) => {
...
try {
  Pe && (window.__reactRouterVersion = "7.6.2");
} catch {}
function fr({ basename: e, children: t, window: r }) {
  let a = u.useRef();
  a.current == null && (a.current = Fe({ window: r, v5Compat: !0 }));
  let n = a.current,
    [o, s] = u.useState({ action: n.action, location: n.location }),
    c = u.useCallback(
      (l) => {
        u.startTransition(() => s(l));
      },
      [s],
    );
  return (
    u.useLayoutEffect(() => n.listen(c), [n, c]),
    u.createElement(Pt, {
      basename: e,
      children: t,
      location: o.location,
...
var ke = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Le = u.forwardRef(function (
    ...
    let { basename: f } = u.useContext(P),
      y = typeof i == "string" && ke.test(i),
      w,
      h = !1;
    if (typeof i == "string" && y && ((w = i), Pe))
      try {
        let b = new URL(window.location.href),
          I = i.startsWith("//") ? new URL(b.protocol + i) : new URL(i),
          ie = $(I.pathname, f);
        I.origin === b.origin && ie != null
          ? (i = ie + I.search + I.hash)
          : (h = !0);
      } catch {
        S(
          !1,
    ...
    function O(b) {
      (t && t(b), b.defaultPrevented || D(b));
    }
    let T = u.createElement("a", {
      ...d,
      ...C,
      href: w || g,
      onClick: h || o ? t : O,
    ...
    return x && !y
      ? u.createElement(u.Fragment, null, T, u.createElement(Jt, { page: g }))
      : T;
  });
Le.displayName = "Link";
var Gt = u.forwardRef(function (
  {
    "aria-current": t = "page",
    caseSensitive: r = !1,
    className: a = "",
  ...
  let p = W(s, { relative: i.relative }),
    d = N(),
    v = u.useContext(K),
    { navigator: f, basename: y } = u.useContext(P),
    w = v != null && ar(p) && c === !0,
    h = f.encodeLocation ? f.encodeLocation(p).pathname : p.pathname,
    g = d.pathname,
    x =
  ...
  let C = g === h || (!n && g.startsWith(h) && g.charAt(R) === "/"),
    D =
      x != null &&
      (x === h || (!n && x.startsWith(h) && x.charAt(h.length) === "/")),
    O = { isActive: C, isPending: D, isTransitioning: w },
    T = C ? t : void 0,
    b;
  typeof a == "function"
    ? (b = a(O))
...
var Xt = u.forwardRef(
  (
    ...
    let f = rr(),
      ...
      h = typeof c == "string" && ke.test(c),
      g = (x) => {
        if ((l && l(x), x.defaultPrevented)) return;
        x.preventDefault();
        let R = x.nativeEvent.submitter,
          C = (R == null ? void 0 : R.getAttribute("formmethod")) || s;
        f(R || x.currentTarget, {
          fetcherKey: t,
          method: C,
          navigate: r,
...
var er = 0,
  tr = () => `__${String(++er)}__`;
function rr() {
  let { router: e } = $e("useSubmit"),
    { basename: t } = u.useContext(P),
    r = Et();
  return u.useCallback(
    async (a, n = {}) => {
      let { action: o, method: s, encType: c, formData: l, body: i } = Dt(a, t);
      if (n.navigate === !1) {
        let m = n.fetcherKey || tr();
...
function nr(e, { relative: t } = {}) {
  ...
  if (e == null) {
    ...
    if (l.some((m) => m === "")) {
      (c.delete("index"),
        l.filter((p) => p).forEach((p) => c.append("index", p)));
      let m = c.toString();
      o.search = m ? `?${m}` : "";
    }
  }
  return (
    ...
    r !== "/" && (o.pathname = o.pathname === "/" ? r : L([r, o.pathname])),
    _(o)
  );
}
function ar(e, t = {}) {
  let r = u.useContext(ve);
  E(
    r != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?",
  );
  let { basename: a } = $e("useViewTransitionState"),
    n = W(e, { relative: t.relative });
  if (!r.isTransitioning) return !1;
  let o = $(r.currentLocation.pathname, a) || r.currentLocation.pathname,
    s = $(r.nextLocation.pathname, a) || r.nextLocation.pathname;
...
//# sourceMappingURL=router-C2VCO5Bu.js.map
