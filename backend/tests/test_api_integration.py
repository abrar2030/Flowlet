...
class TestMultiCurrencyAPI:
    ...
    def test_get_supported_currencies(self, client, auth_headers):
        ...
        response = client.get('/api/v1/multicurrency/currencies/supported', headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_get_exchange_rates(self, client, auth_headers):
        ...
        response = client.get('/api/v1/multicurrency/exchange-rates?base=USD', headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_currency_conversion(self, client, auth_headers):
        ...
        response = client.post('/api/v1/multicurrency/convert', json=conversion_data, headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_create_currency_wallet(self, client, auth_headers):
        ...
        response = client.post('/api/v1/multicurrency/wallets', json=wallet_data, headers=auth_headers)
        assert response.status_code == 201
...
class TestEnhancedCardsAPI:
    ...
    def test_create_virtual_card(self, client, auth_headers):
        ...
        wallet_response = client.post('/api/v1/multicurrency/wallets', 
                                    json={'currency': 'USD'}, 
        ...
        response = client.post('/api/v1/cards/enhanced/cards', json=card_data, headers=auth_headers)
        assert response.status_code == 201
    ...
    def test_update_card_controls(self, client, auth_headers):
        ...
        card_response = client.post('/api/v1/cards/enhanced/cards', 
        ...
        response = client.put(f'/api/v1/cards/enhanced/cards/{card_id}/controls', 
                            json=update_data, 
                            headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_freeze_unfreeze_card(self, client, auth_headers):
        ...
        # Freeze card
        freeze_response = client.post(f'/api/v1/cards/enhanced/cards/{card_id}/freeze', 
        ...
        # Unfreeze card
        unfreeze_response = client.post(f'/api/v1/cards/enhanced/cards/{card_id}/unfreeze', 
                                      headers=auth_headers)
...
class TestMonitoringAPI:
    ...
    def test_analyze_transaction(self, client, auth_headers):
        ...
        response = client.post('/api/v1/monitoring/transaction/analyze', 
                             json=analysis_data, 
                             headers=auth_headers)
    ...
    def test_get_monitoring_dashboard(self, client, auth_headers):
        ...
        response = client.get('/api/v1/monitoring/monitoring/dashboard', headers=auth_headers)
...
class TestComplianceAPI:
    ...
    def test_watchlist_screening(self, client, auth_headers):
        ...
        response = client.post('/api/v1/compliance/screening/watchlist', 
                             json=screening_data, 
                             headers=auth_headers)
    ...
    def test_compliance_dashboard(self, client, auth_headers):
        ...
        response = client.get('/api/v1/compliance/compliance/dashboard', headers=auth_headers)
...
class TestErrorHandling:
    ...
    def test_validation_error(self, client, auth_headers):
        ...
        response = client.post('/api/v1/multicurrency/convert', 
                             json=invalid_data, 
                             headers=auth_headers)
