...
_ **Security Baseline:** Helps establish a secure baseline for development environments, ensuring that developers are working with appropriate configurations and tools from the outset.
_ **Usage:**
`bash
        ./setup-dev.sh
